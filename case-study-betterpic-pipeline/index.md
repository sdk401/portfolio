...
![Typical SD 1.5 API output — note the skin texture, eye detail, and background quality](img/before.png)
...
![Old pipeline vs new pipeline architecture](img/pipelines.png)
*Pipeline comparison*
...
![Headshots generated by the new FLUX in-house pipeline](img/after.png)
